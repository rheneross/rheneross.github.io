---
{"dg-publish":true,"permalink":"/notes/project-planning/","tags":["gamedev","planning"]}
---
...
# Big picture
## Make a plan
1. Define what game we are making => Single Page GDD!
2. Set an ideal release date
3. Give it a feasibility factor 0-10
4. Calculate how much dev. Time we have until ideal release date
5. How is feasibility factor now? Adjust scope,  and potentially release date
## Back planning
Define Key Milestones
1. When are the latest Steam Next Fest before release?
2. Demo should be ready one month before the start of Next Fest
3. Steam Page should be ready 1 month before inscription deadline
4. First Vertical Slice for screenshots / trailer need to be done 2 weeks before Steam page
